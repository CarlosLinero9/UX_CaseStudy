...
Como conclusión de la práctica anterior, hemos sintetizado los principales hallazgos mediante un Feedback Capture Grid, con el objetivo de reformular el problema de diseño a partir del análisis competitivo, las personas, los journey maps y la usability review. En nuestro caso, el estudio muestra que la experiencia actual tiene una base sólida, pero todavía presenta fricciones en tareas clave, especialmente en móvil: encontrar rápidamente la información esencial del local, explorar la tienda con claridad y comprar con confianza.
